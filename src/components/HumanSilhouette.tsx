...
export default function HumanSilhouette({
  ...
  return (
    <div className="relative w-full max-w-sm mx-auto flex flex-col items-center select-none" id="human-blueprint-container">
      ...
      {/* Main SVG Blueprint */}
    <div className="relative w-full aspect-[5/6] bg-white rounded-3xl border border-brand-amber/20 shadow-sm p-4 overflow-hidden flex items-center justify-center">
